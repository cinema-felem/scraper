...
const mapMovies = (input: ProjectorRawMovie[]): MappedMovies[] => {
...
const getCinemaScreenDetails = (
  ...
  for (const cinema of cinemaArray) {
    ...
    for (const venue of cinema.source.chainSpecific.venues) {
...
const mapCinemas = (input: ProjectorRawCinema[]): MappedCinema[] => {
